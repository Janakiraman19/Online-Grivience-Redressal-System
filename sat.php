            ...
            if (isset($_REQUEST['sub']) and isset($_REQUEST['username']))
             {
              ...
              if($rows == 1)
              {
                  if(mail($mail_id, 'OPAC message','Username: '.$name .'password: '.$password,'From:sathishm.17msc@kongu.edu')){
                    ...
                    echo "<div class='box'><h4 style='color:white'>Something went wrong! try after few minits or check your internet connection.</h4><br/> <a href='login.php'>Okay</a></div>";
        ...
        if (isset($_REQUEST['reset'])) {
          ...
          { ?>
            <form class="box" method="post">
              ...
              <input type="text" name="password" placeholder="password" maxlength="13" minlength="8" required/>
              <input type="text" name="cpassword" placeholder="Confrim password" maxlength="13" minlength="8" required/>
